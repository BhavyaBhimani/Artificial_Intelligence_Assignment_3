...
def stochastic_hill_climbing(board, n, max_iterations=10, verbose=False):
    	...
    	for i in range(max_iterations):
    		# Get the random heuristic child from the find child helper function
...
print('Total Time:  ' + str((end-start)*1000) + ' milliseconds')
print('Success rate: ' + str(success_rate/iterations))
print('Failure rate: ' + str(1-(success_rate/iterations)))
print('Average steps when success: ' + str(step_count_rate/success_rate))
print('Average steps when failure: ' + str(step_count_rate_failure/(iterations - success_rate)))
